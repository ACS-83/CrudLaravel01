...
class AsignaturaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'descripcion' => ['required', 'string', 'min:3', 'max:80'],
            'creditos' => ['required', 'integer', 'min:1', 'max:9'],
    ...
    {
        return view('asignaturas.detalles', compact('asignatura'));
    }
    ...
    {
        $misProfesores=Profesor::getArrayIdNombre();
        return view('asignaturas.editar', compact('asignatura', 'misProfesores'));
    }
